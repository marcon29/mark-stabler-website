...
describe "CopySection" do
    ...
    # it can have a css_class, page_location, headline, body_copy, link
    ...
    # it has a required, unique name (case insensitive) and provides correct error message when invalid
    ...
    # it can have a unique page_location that is an integer and provides correct error message when invalid
        # create and persist a valid seed instance
    ...
    # helper method tests ########################################################
    # it can tell if the link is absolute or relative
    ...
    # it has a properly created slug
    ...
    # it can be found by its slug
        # create an instance with all attrs (multi-word name, mixed case, w/ punctuation and special characters)
            # expect instance.find_by_slug("given name in slug format") to equal the instance

    # it can return only the properly formatted date the object was created and updated
