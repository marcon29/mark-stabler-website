...
describe "SocialPlatform" do        
    ...
    describe "has a required, unique base_url (case insensitive) that matches standard url text patterns and provides correct error message when invalid" do
        ...
        it "will instantiate with a variety of possible base_url user entries" do
            ...
            full_attrs = {name: "platform1 name", base_url: "http://www.example.com", image_file_name: "icon1.png"}
            full_secure_attrs = {name: "platform2 name", base_url: "https://www.example.com", image_file_name: "icon2.png"}
            trailing_slash_attrs = {name: "platform3 name", base_url: "https://www.example.com/", image_file_name: "icon3.png"}
            no_www_attrs = {name: "platform4 name", base_url: "http://example.com", image_file_name: "icon4.png"}
            no_www_secure_attrs = {name: "platform5 name", base_url: "https://example.com", image_file_name: "icon5.png"}
